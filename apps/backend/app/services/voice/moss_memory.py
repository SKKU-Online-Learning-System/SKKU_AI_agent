...
class MossMemoryStore:
    ...
    def __init__(
        ...
        *,
        ...
        self.project_id = (project_id or settings.moss_project_id or "").strip()
        self.project_key = (project_key or settings.moss_project_key or "").strip()
        self.index_name = (index_name or settings.moss_memory_index).strip()
        self.model_id = (model_id or settings.moss_memory_model).strip()
        self.student_id = (student_id or "default-student").strip()
        self.sync_debounce_seconds = (
            settings.moss_sync_debounce_seconds
