...
텍스트와 음성 모두 학생의 직전 답에 피드백한 뒤 작은 사고 질문 하나로 이어갑니다.
막히면 예시·선택지로 난도를 낮추고, 맞히면 다음 단계로 진행합니다. 설명 모드 선택은
없습니다. 짧은 후속 답변은 직전 문맥으로 검색하고 최근 시각화는 다음 턴에도 제공합니다.
